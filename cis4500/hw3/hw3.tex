...
\part
  ...
  \begin{solution}
    T2's \texttt{SELECT} at time 6 only Luca. Which is the same thing that was returned in question 4. This is because the difference between \texttt{REPEATABLE READ} and \texttt{SERIALIZABLE} is how they handle serialization anomalies. Because there is
    no serialization anomalies in our execution we get the same result.
  \end{solution}
